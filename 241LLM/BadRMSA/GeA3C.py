...
from GeAgent_test import DeepRMSA_Agent
...
output_dir = "/data/chl/pyproject/DeepRSA/output1/"
...
with tf.device("/cpu:0"):
    ...
    #trainer = tf.keras.optimizers.Adam(learning_rate=1e-5)#origin
    trainer = tf.keras.optimizers.Adam(learning_rate=1e-6)
